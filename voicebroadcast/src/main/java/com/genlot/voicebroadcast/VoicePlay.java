package com.genlot.voicebroadcast;
...
import com.genlot.voicebroadcast.util.FileUtils;
    ...
    private void start(final List<String> voicePlay) {
        synchronized (VoicePlay.this) {
            ...
            try {
                ...
                Log.e("sty", "--> " + String.format(VoiceConstants.FILE_PATH, voicePlay.get(counter[0])));
